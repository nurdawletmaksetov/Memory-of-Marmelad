...
import FirstMusic from '../assets/RisesTheMoon.mp3'
import SeconMusic from "../assets/Memory.mp3";
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "8px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        <div style={{ marginLeft: "auto", display: "flex", gap: "8px" }}>
                            <button onClick={() => setIndex((index - 1 + tracks.length) % tracks.length)}><ArrowLeft /></button>
                    ...
                    <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                        ...
                        <div
                            style={{ flex: 1, position: "relative", height: "6px", background: "rgba(255,255,255,0.06)", borderRadius: "999px", overflow: "hidden" }}
                            onClick={(e) => {
